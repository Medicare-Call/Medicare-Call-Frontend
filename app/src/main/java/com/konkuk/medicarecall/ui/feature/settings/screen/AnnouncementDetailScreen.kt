...
import com.konkuk.medicarecall.ui.feature.settings.viewmodel.DetailNoticeViewModel
...
fun AnnouncementDetailScreen(
    ...
    noticeId: Int,
    onBack: () -> Unit = {},
    detailViewModel: DetailNoticeViewModel = koinViewModel(),
) {
    val noticeData by detailViewModel.noticeData.collectAsStateWithLifecycle()
